...
class Ui_addProduct_Window(object):
    ...
    def insertData(self):
        ...
        if (self.allFieldsValidation()):
                if any(chr.isdigit() for chr in name):
                        ...
                        try:
                                connection.execute("INSERT INTO product VALUES(?,?,?,?,?,?,?)",(product_id,name,category,stock,cost_price,mrp,description))
                                connection.commit()
    ...
    def allFieldsValidation(self):
        ...
        if ((product_id != "" and  product_id.isspace() == False) and (name != "" and  name.isspace() == False) and (cost_price != "" and  cost_price.isspace() == False) and (mrp != "" and  mrp.isspace() == False) and (category != "" and  category.isspace() == False) and (stock != "" and  stock.isspace() == False)):
                ...
                self.label_6.setStyleSheet("")
                return False
    def setupUi(self, addProduct_Window):
        addProduct_Window.setObjectName("addProduct_Window")
        addProduct_Window.setWindowFlags(QtCore.Qt.FramelessWindowHint)            
        addProduct_Window.setAttribute(QtCore.Qt.WA_TranslucentBackground)
        addProduct_Window.resize(1350, 833)
        addProduct_Window.setStyleSheet("QPushButton{\n"
...
"}\n"
"")
        self.label = QtWidgets.QLabel(addProduct_Window)
...
"border-top-right-radius:5px;")
        ...
        self.label_2 = QtWidgets.QLabel(addProduct_Window)
...
"border-top-left-radius:50px;")
        ...
        self.label_3 = QtWidgets.QLabel(addProduct_Window)
        ...
        self.productId_LE = QtWidgets.QLineEdit(addProduct_Window)
...
"padding-bottom:7px;")
        ...
        self.category_LE = QtWidgets.QLineEdit(addProduct_Window)
...
"padding-bottom:7px;")
        ...
        self.submit_btn = QtWidgets.QPushButton(addProduct_Window)
        ...
        self.label_4 = QtWidgets.QLabel(addProduct_Window)
        ...
        self.description_LE = QtWidgets.QLineEdit(addProduct_Window)
...
"padding-bottom:7px;")
        ...
        self.inStock_LE = QtWidgets.QLineEdit(addProduct_Window)
...
"padding-bottom:7px;")
        ...
        self.name_LE = QtWidgets.QLineEdit(addProduct_Window)
...
"padding-bottom:7px;")
        ...
        self.mrp_LE = QtWidgets.QLineEdit(addProduct_Window)
...
"padding-bottom:7px;")
        ...
        self.costPrice_LE = QtWidgets.QLineEdit(addProduct_Window)
...
"padding-bottom:7px;")
        ...
        self.back_btn = QtWidgets.QPushButton(addProduct_Window)
        self.back_btn.setGeometry(QtCore.QRect(1200, 30, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(1)
...
"border-radius:5px;")
        ...
        self.label_5 = QtWidgets.QLabel(addProduct_Window)
        self.label_5.setGeometry(QtCore.QRect(740, 680, 421, 91))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.label_6 = QtWidgets.QLabel(addProduct_Window)
        ...
        if invManagement.barcode_id != "":
                self.productId_LE.setDisabled(True)
                self.productId_LE.setText(invManagement.barcode_id)
        
        self.submit_btn.clicked.connect(self.insertData)
        self.back_btn.clicked.connect(addProduct_Window.close)
        self.back_btn.clicked.connect(self.invManagement)
        
        self.retranslateUi(addProduct_Window)
        QtCore.QMetaObject.connectSlotsByName(addProduct_Window)
        
    def retranslateUi(self, addProduct_Window):
        _translate = QtCore.QCoreApplication.translate
        addProduct_Window.setWindowTitle(_translate("addProduct_Window", "Form"))
        self.label.setText(_translate("addProduct_Window", "TextLabel"))
        self.label_3.setText(_translate("addProduct_Window", "ADD PRODUCT"))
        self.productId_LE.setPlaceholderText(_translate("addProduct_Window", "Product ID"))
        self.category_LE.setPlaceholderText(_translate("addProduct_Window", "Category"))
        self.submit_btn.setText(_translate("addProduct_Window", "Submit"))
        self.label_4.setText(_translate("addProduct_Window", "-"))
        self.description_LE.setPlaceholderText(_translate("addProduct_Window", "Description (Optional)"))
        self.inStock_LE.setPlaceholderText(_translate("addProduct_Window", "In Stock"))
        self.name_LE.setPlaceholderText(_translate("addProduct_Window", "Name"))
        self.mrp_LE.setPlaceholderText(_translate("addProduct_Window", "MRP"))
        self.costPrice_LE.setPlaceholderText(_translate("addProduct_Window", "Cost Price"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    addProduct_Window = QtWidgets.QWidget()
    ui = Ui_addProduct_Window()
    ui.setupUi(addProduct_Window)
    addProduct_Window.show()
    sys.exit(app.exec_())
