...
class Ui_addSupp_Window(object):

    def suppManagement(self,x):                             ##2
    ...
    def insertData(self):
        ...
        payment_due = self.payment_due.text()
        ...
        if (self.allFieldsValidation()):
                if(suppId.startswith('SUPP') == False):
                        ...
                        try:
                                connection.execute("INSERT INTO supplier VALUES(?,?,?,?,?,?,?)",(suppId,name,contact,product_cat,payment_due,last_payment_date,address))
                                connection.commit()
...
"padding-bottom:7px;")
        ...
        self.payment_due = QtWidgets.QLineEdit(addEmp_Window)
        self.payment_due.setGeometry(QtCore.QRect(560, 390, 311, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(15)
        self.payment_due.setFont(font)
        self.payment_due.setStyleSheet("background-color:rgba(0,0,0,0);\n"
"border:none;\n"
"border-bottom:2px solid rgba(46,82,101,200);\n"
"color:rgba(0,0,0,240);\n"
"padding-bottom:7px;")
        self.payment_due.setText("")
        self.payment_due.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.payment_due.setObjectName("payment_due")
...
"border-radius:5px;")
    ...
    def retranslateUi(self, addEmp_Window):
        ...
        self.label_3.setText(_translate("addEmp_Window", "ADD SUPPLIER"))
        ...
        self.payment_due.setPlaceholderText(_translate("addEmp_Window", "Payment Due"))

if __name__ == "__main__":                                    ##6
    app = QtWidgets.QApplication(sys.argv)
    Form = QtWidgets.QWidget()
    ui = Ui_addSupp_Window()
    ui.setupUi(Form)
    Form.show()
    sys.exit(app.exec_())
